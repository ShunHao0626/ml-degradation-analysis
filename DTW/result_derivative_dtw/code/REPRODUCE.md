...
```sh
cd /Users/shunhao/Desktop/ML/method2/result_derivative_dtw
...
当前目录的可视化首页由 `python3 code/export_visual_results.py` 生成。交互 HTML 已核对数据、菜单与本地依赖；由于没有连接的浏览器，未做实际浏览器点击测试。
